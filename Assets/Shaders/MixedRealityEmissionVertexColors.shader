...
// Tweaked MRTK shader variant that multiplies emission color with vertex colors too,
// instead of just the albedo.

Shader "Mixed Reality Toolkit/EmissionVertexColors"
{
    Properties
    {
        // Main maps.
        ...
        [Toggle(_VERTEX_COLORS_TO_ALPHA)] _VertexColorsToAlpha("Vertex Colors To Alpha", Float) = 0.0
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #pragma shader_feature _VERTEX_COLORS_TO_ALPHA
...
#if defined(_VERTEX_COLORS)
#if defined(_VERTEX_COLORS_TO_ALPHA)
                o.color.rgb = fixed3(255, 255, 255);
                o.color.a = 0.333 * (v.color.r + v.color.g + v.color.b);
#else
                o.color = v.color;
#endif
#endif
