...
namespace Microsoft.MixedReality.Toolkit.PoseMatching
{
    class MathUtilsTests
    {
        ...
        public void ApproximateGivensRotation()
        {
            ...
            foreach (float a11 in values)
            {
                foreach (float a12 in values)
                {
                    ...
                    {
                        TestGivensApproximation( a11,  a12,  a22);
                        TestGivensApproximation(-a11,  a12,  a22);
                        TestGivensApproximation( a11, -a12,  a22);
                        TestGivensApproximation(-a11, -a12,  a22);
                        TestGivensApproximation( a11,  a12, -a22);
        ...
        void TestGivensApproximation(float a11, float a12, float a22)
        {
            float a21 = a12;
            ...
            Assert.AreEqual(0.0f, aaa12, ExpectedGivensEpsilon, $"Givens rotation for (({a11}, {a12}), ({a21}, {a22})) does not diagonalize matrix");
            Assert.AreEqual(0.0f, aaa21, ExpectedGivensEpsilon, $"Givens rotation for (({a11}, {a12}), ({a21}, {a22})) does not diagonalize matrix");
        }
    }
}